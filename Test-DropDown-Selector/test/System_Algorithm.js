describe("Integration test for the multi selector", () => {
    ...
    const itemCombo = [['Item 3', 'Item 1', 'Item 6']]
    const Algorithm = [['Item 3', 'Item 7', 'Item 4' , 'Item 1' , 'Item 7', 'Item 6', 'Item 4']];
    ...
    multipleItemSelectTest(itemCombo, Algorithm, multiSelectArrow, scrollCoordinatesSet);

    function multipleItemSelectTest(itemCombo, algorithm, dropDownArrow, scrollCoordinates){
        context("When choosing multiple items that needs scrolling", () => {
            ...
            multipleItemTest(itemCombo[0], algorithm[0]);
        
            function multipleItemTest(items, pattern){
                it(`should have ${items.join(', ')} selected`, async () => {
                    ...
                    for(let i = 0; i < pattern.length; i ++){
                        if(displayedItemList.indexOf(pattern[i]) == -1 && top){
                        ...
                        else if(displayedItemList.indexOf(pattern[i]) == -1 && !top){
